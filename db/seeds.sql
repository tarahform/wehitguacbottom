...
-- users tabledata
insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age, shoppingcart)
values ('Nicholas', 'Madrid', 'Edwards', 'photolink', 'n.m.e.dummyemail@gmail.com', '7086622234', 18, null);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age, shoppingcart)
values ('Daniel', 'Remember', 'Alamo', 'photolink', 'dalamo.dummyemail@gmail.com', '3125484991', 26, null);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age, shoppingcart)
values ('Halle', 'Reid', 'Conger', 'photolink', 'halle.dummyemail@gmail.com', '4136131284', 26, null);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age, shoppingcart)
values ('Tahrah', 'Leah', 'Perry', 'photolink', 'tahrah.dummyemail@gmail.com', '6304306422', 26, null);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age, shoppingcart)
values ('Ali', 'Prince', 'Arfeen', 'photolink', 'ali.dummyemail@gmail.com', '5689930088', 26, null);
