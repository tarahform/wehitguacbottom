...
-- users tabledata
insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age)
values ("Nicholas", "Madrid", "Edwards", "photolink", "n.m.e.dummyemail@gmail.com", "7086622234", 18);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age)
values ("Daniel", "Remember", "Alamo", "photolink", "dalamo.dummyemail@gmail.com", "3125484991", 26);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age)
values ("Halle", "Reid", "Conger", "photolink", "halle.dummyemail@gmail.com", "4136131284", 26);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age)
values ("Tahrah", "Leah", "Perry", "photolink", "tahrah.dummyemail@gmail.com", "6304306422", 26);

insert into users (first_name, middle_name, last_name, photo_link, email, phone_number, age)
values ("Ali", "Prince", "Arfeen", "photolink", "ali.dummyemail@gmail.com", "5689930088", 26);
